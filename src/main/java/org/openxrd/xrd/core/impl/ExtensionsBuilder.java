...
/**
 * Builder for {@link ExtensionsImpl} objects.
 */
public class ExtensionsBuilder extends AbstractXRDObjectBuilder<Extensions> {

    /** {@inheritDoc} */
    public Extensions buildObject() {
        return buildObject(XRDConstants.XRD_NS, Extensions.DEFAULT_ELEMENT_LOCAL_NAME, XRDConstants.XRD_PREFIX);
    }
