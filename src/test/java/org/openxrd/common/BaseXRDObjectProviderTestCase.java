...
/**
 * Base test case for all OpenXRD tests that work with {@link org.openxrd.xrd.common.XRDObject}s.
 */
public abstract class BaseXRDObjectProviderTestCase extends BaseTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        if (singleElementFile != null) {
            expectedDOM = parser.parse(BaseXRDObjectProviderTestCase.class
                    .getResourceAsStream(singleElementFile));
        }

        if (singleElementOptionalAttributesFile != null) {
            expectedOptionalAttributesDOM = parser.parse(BaseXRDObjectProviderTestCase.class
                    .getResourceAsStream(singleElementOptionalAttributesFile));
        }

        if (childElementsFile != null) {
            expectedChildElementsDOM = parser.parse(BaseXRDObjectProviderTestCase.class
